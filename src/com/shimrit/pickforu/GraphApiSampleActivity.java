...
public class GraphApiSampleActivity extends Activity {
    static final String APP_ID = "143407059196911";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sToken=fb.getAccessToken();
        Log.d("BUGBUG","TOKENIS"+sToken);
    }
            ...
            StatusCallback callback = new StatusCallback() {
                public void call(Session session, SessionState state, Exception exception) {
                    if (exception != null) {
                        ...
                        Log.d("sessionTokenDueDate", session.getExpirationDate().toLocaleString());
                        Log.d("BUGBUG","TOKENIS"+sToken);
                    }
                }
            };
